...
Usage:
    python scripts/augment_data_reflect.py [--input_dir PATH] [--output_dir PATH]

Or from repo root:
    python -m scripts.augment_data_reflect
...
Ported verbatim from slayminton/scripts/augment_data_reflect.py.
"""
